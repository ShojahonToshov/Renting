...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-b from-emerald-50/90 via-emerald-50/60 to-transparent backdrop-blur-md dark:from-gray-900/90 dark:via-gray-900/60">
      <div className="container mx-auto flex items-center gap-4 p-4 md:px-6">
        ...
        <a className="flex items-center gap-3 title-font font-medium text-gray-900 dark:text-white">
          ...
          <button
            ...
            className="ml-1 flex h-9 w-9 items-center justify-center rounded-full text-gray-400 transition-colors hover:bg-emerald-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white"
          >
      ...
      {/* Sidebar */}
      <aside
        className={`fixed right-0 top-0 z-50 flex h-full w-72 flex-col gap-6 bg-white p-6 shadow-2xl backdrop-blur-2xl transition-transform duration-300 md:hidden dark:bg-gray-900/90 ${
      ...
      >
        ...
        <button
          ...
          onClick={Theme}
          aria-label="Toggle theme"
          className="flex h-9 w-9 items-center justify-center self-start rounded-full text-gray-400 transition-colors hover:bg-emerald-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white"
        >
          {dark ? <Sun size={18} /> : <Moon size={18} />}
        </button>
